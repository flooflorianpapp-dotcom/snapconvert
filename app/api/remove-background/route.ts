  ...
  try {
    ...
    if (!apiKey) {
      return NextResponse.json(
        { error: "API key not configured. Please add REMOVE_BG_API_KEY to your environment variables." },
        { status: 500 }
      )
    }
    ...
    // Validate file size (remove.bg limit is 12MB for free, 25MB for paid)
    ...
    // Get the image data as buffer and convert to base64
